...
## jabin_user Module (depends on jabin_core)
- [x] Create module manifest + __init__
- [x] Create res_users.py model (JabinUser extends jabin.user)
...
## jabin_security Module (depends on jabin_core, jabin_user)
- [x] Create module manifest + __init__
...
## jabin_auth Module (depends on jabin_core, jabin_user, jabin_security)
- [x] Create module manifest + __init__
